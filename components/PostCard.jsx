  ...
  <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
    ...
    <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
      <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8">
        ...
        />
        <p className="inline align-middle text-gray-700 mb-0 ml-2 font-medium text-lg">{post.author.name}</p>
      </div>
    ...
    <div className="text-center">
      <Link href={`/post/${post.slug}`}>
        <span className="transition duration-500 ease transform bg-blue-600 inline-block rounded-full hover:scale-105 text-white px-4 py-2 cursor-pointer">Continue Reading</span>
      </Link>
    </div>
  </div>
);
