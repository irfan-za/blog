...
const AdjacentPostCard = ({ post, position }) => (
  <>
    ...
    <div className="flex flex-col rounded-lg p-4 items-center justify-center absolute w-full h-full">
      <p className="text-white text-shadow md:font-semibold text-xs">{moment(post.createdAt).format('MMM DD, YYYY')}</p>
      <p className="text-white text-shadow font-semibold text-base md:text-lg lg:text-2xl text-center">{post.title}</p>
    </div>
